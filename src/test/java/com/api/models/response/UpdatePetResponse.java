...
import com.api.request.models.UpdatePetRequest.category;
...
public class UpdatePetResponse {
	...
	public UpdatePetResponse(int id, String name, category category, List<String> photoUrls, List<tags> tags,
			String status) {
		super();
		this.id = id;
		this.name = name;
